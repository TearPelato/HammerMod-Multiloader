...
public class Config {
    ...
    public static class Client {
        @ConfigProperty(name = "VeinMiner Settings", comment = "VeinMiner Settings category")
        public final VeinMiner veinMineSettings = new VeinMiner();

        @ConfigProperty(name = "Misc Settings", comment = "Misc Settings category")
        public final Misc miscSettings = new Misc();
