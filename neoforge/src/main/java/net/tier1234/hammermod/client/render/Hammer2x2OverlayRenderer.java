...
public class Hammer2x2OverlayRenderer {
    ...
    public static void register() {
        NeoForge.EVENT_BUS.register(new Hammer2x2OverlayRenderer());
    }
    ...
    public void onRenderBlockHighlight(RenderHighlightEvent.Block event) {
        ...
        if (held.getItem().getClass() != HammerItem2x2.class) return;
        ...
        List<BlockPos> area = get2x2Blocks(target, face, blockHit.getLocation());
